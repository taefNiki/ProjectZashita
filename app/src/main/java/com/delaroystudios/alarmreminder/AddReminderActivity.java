...
/**
 * Created by taefNiki on 02/13/18.
 */
...
public class AddReminderActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRepeatText.setText("Каждый(ые/ую) " + mRepeatNo + " " + mRepeatType);
    ...
    public void setTime(View v){
        if(mCurrentReminderUri == null){
            Toast.makeText(this, "нажмите еще раз на список напоминаний, чтобы установить дату сигнала", Toast.LENGTH_LONG).show();
            return;
        }
...
*/
        ...
        // Check repeat type
        if (mRepeatType.equals("Минута")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milMinute;
        } else if (mRepeatType.equals("Час")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milHour;
        } else if (mRepeatType.equals("День")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milDay;
        } else if (mRepeatType.equals("Неделя")) {
            mRepeatTime = Integer.parseInt(mRepeatNo) * milWeek;
        } else if (mRepeatType.equals("Месяц")) {
    ...
    public void onLoadFinished(Loader<Cursor> loader, Cursor cursor) {
        ...
        if (cursor.moveToFirst()) {
            ...
            mRepeatText.setText("Каждый(ые/ую)" + repeatNo + " " + repeatType);
            // Setup up active buttons
            // Setup repeat switch
            if (repeat == null){
