...
public class AlarmCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        if (date != null){
            ...
            mDateAndTimeText.setText("Дата не установлена");
        }

        if(repeat != null){
            setReminderRepeatInfo(repeat, repeatNo, repeatType);
        }else{
            mRepeatInfoText.setText("Повторение не установлено");
        }
    ...
    public void setReminderRepeatInfo(String repeat, String repeatNo, String repeatType) {
        if(repeat.equals("true")){
            mRepeatInfoText.setText("Каждый(ые/ую)" + repeatNo + " " + repeatType);
        }else if (repeat.equals("false")) {
            mRepeatInfoText.setText("Повтор отключен");
        }
    }
